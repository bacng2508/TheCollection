    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-3 border border-black px-5 py-4">
                <div>
                    <form action="{{ route('client.product.search') }}" method="GET" id="filter-form">
                        <input type="hidden" name="q" value="{{ $q }}">
                        <input type="hidden" name="cat" value="{{ $cat }}">
                        <div class="d-flex justify-content-between align-items-center">
                            <h3 class="my-1">LỌC THEO</h3>
                            <button type="submit" class="btn btn-primary px-3 py-1" style="border-radius: 5px;"><i
                                    ...
                                    @foreach ($attributeOptions->where('attribute_id', $attribute->id) as $attributeOption)
                                        <div class="form-group form-check mb-1">
                                            <input type="checkbox" class="form-check-input"
                                                id="attribute_option_{{ $attributeOption->id }}" name="attribute_options[]"
            ...
            <div class="col-9">
                <div class="row px-5 justify-content-between align-items-center mb-2">
                    <h4 class="px-3 mb-0">Kết quả tìm kiếm: "{{ $q }}"</h4>
                    <div class="">
